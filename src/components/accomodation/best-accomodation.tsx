...
import {  useAccomodation } from "../context/accomodation-context"; // adatta il path
import { Home, Star, MapPin, Trophy } from 'lucide-react'; // icone opzionali
    ...
    return (
        <div className='flex flex-col items-center gap-2 wrap-anywhere'>
            ...
            <div className="flex flex-col items-center gap-6 p-6 bg-gray-50 rounded-xl border border-gray-200 shadow-sm">
                ...
                >
                    <Trophy size={18} />
                    {loading ? "Calculating..." : "Get Best Accomodation"}
                </button>
